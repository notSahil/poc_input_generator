...
| [`job_store.py`](core/job_store.py) | 681 | SQLite-backed persistent job queue, atomic locking, checkpointing, and notifications. | — | `get_db()`, `init_db()`, `create_job()`, `mark_job_running()`, `update_job_progress()`, `complete_job()` |
